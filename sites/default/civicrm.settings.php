...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal:YaXQB2B7dY6RXmnT@c-corp.czxe9p4vl99q.eu-west-1.rds.amazonaws.com/c_corp_drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicrm:TypCC642zztYe7qW@c-corp.czxe9p4vl99q.eu-west-1.rds.amazonaws.com/c_corp_civicrm?new_link=true');
  }
}
...
$civicrm_root = '/var/www/c-corp/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/c-corp/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://c-corp.tk');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '55f6ef16b25e9ddd8e88aa47c095c3c5');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/c-corp/sites/default/files/civicrm/templates_c/mail.log');
// }
